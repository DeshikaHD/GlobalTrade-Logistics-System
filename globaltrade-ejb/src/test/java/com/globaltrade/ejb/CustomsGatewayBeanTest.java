...
public class CustomsGatewayBeanTest {
    ...
    public static JavaArchive createDeployment() {
        return ShrinkWrap.create(JavaArchive.class)
            .addClasses(CustomsGatewayBean.class, CustomsGatewayLocal.class, CustomsGatewayRemote.class,
                        ...
                        com.globaltrade.ejb.interceptor.PerformanceMonitoringInterceptor.class,
            ...
            .addAsManifestResource(new java.io.File("src/test/resources/META-INF/persistence-test.xml"), "persistence.xml");
    }
