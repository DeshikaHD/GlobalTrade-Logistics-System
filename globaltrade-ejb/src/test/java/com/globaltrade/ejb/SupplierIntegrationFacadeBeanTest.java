...
public class SupplierIntegrationFacadeBeanTest {
    ...
    public static JavaArchive createDeployment() {
        return ShrinkWrap.create(JavaArchive.class)
                .addClasses(
                        ...
                        SupplierIntegrationFacadeLocal.class,
    ...
    public void testFulfillOrderSuccess() {
        String trk = "TRK-" + UUID.randomUUID().toString();
        SupplierOrder fulfilled = wrapper.fulfillOrder(testOrder.getOrderId(), trk, true);
        ...
        assertEquals(trk, fulfilled.getShipment().getTrackingNumber());
        assertEquals(com.globaltrade.core.enums.ShipmentStatus.READY_FOR_EXPORT, fulfilled.getShipment().getStatus());
    }

    @Test
    public void testFulfillOrderInvalidState() {
        String trk = "TRK-" + UUID.randomUUID().toString();
        wrapper.fulfillOrder(testOrder.getOrderId(), trk, true);
        
        assertThrows(InvalidOrderStateException.class, () -> {
            wrapper.fulfillOrder(testOrder.getOrderId(), "TRK-" + UUID.randomUUID().toString(), true);
